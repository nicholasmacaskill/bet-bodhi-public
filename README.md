...
- [x] Supabase: users, bets, coaching_sessions
- [x] Basic bias detection (chasing losses, win streak complacency)
- [x] Seven Pillars coaching prompts

### Phase 2 – Betting History Analysis (1 week)
- [x] Bet logging (manual + API import)
- [x] Pattern detection across 100+ sessions
- [x] Personalized coaching recommendations
- [x] Bankroll management calculator

### Phase 3 – Real-Time Interventions (1 week)
- [x] Pre-bet coaching flow (Pillar checklist)
- [x] Live odds integration
- [x] Emotional state tracking
- [x] Session win/loss streak monitoring

## 📱 Demo
Bet Bodhi Chat Coach Bias Detection (Screenshots coming as chat UI is built)
...
Creator: nicholasmacaskill Issues: Open issue
